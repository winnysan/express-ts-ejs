...
window.localization = {
  ...
  dictionaries: {
    sk: {
      ...
      categoryMultiselectHandlerHasBeenInitialized: 'Category multiselect handler bol inicializovaný',
    ...
    en: {
      ...
      categoryMultiselectHandlerHasBeenInitialized: 'Category multiselect handler has been initialized',
